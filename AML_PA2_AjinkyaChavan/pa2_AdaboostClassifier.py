...
if __name__ == "__main__":
    ...
    #estimator = AdaBoostClassifier(n_estimators=5, base_estimator=DecisionTreeClassifier(max_depth=5)) 
    #estimator = AdaBoostClassifier(n_estimators=5, base_estimator=DecisionTreeClassifier(max_depth=10))
    #estimator = AdaBoostClassifier(n_estimators=5, base_estimator=DecisionTreeClassifier(max_depth=100))
    #estimator = AdaBoostClassifier(n_estimators=50, base_estimator=DecisionTreeClassifier(max_depth=5))
    estimator = AdaBoostClassifier(n_estimators=50, base_estimator=DecisionTreeClassifier(max_depth=10)) 
    #estimator = AdaBoostClassifier(n_estimators=50, base_estimator=DecisionTreeClassifier(max_depth=100))
    #estimator = AdaBoostClassifier(n_estimators=100, base_estimator=DecisionTreeClassifier(max_depth=5))
    #estimator = AdaBoostClassifier(n_estimators=100, base_estimator=DecisionTreeClassifier(max_depth=10))
    #estimator = AdaBoostClassifier(n_estimators=100, base_estimator=DecisionTreeClassifier(max_depth=100))        
